...
public:
    ...
    void Init(IndexMetadata* meta_data, TableInfo* table_info, BufferPoolManager* buffer_pool_manager) {
        ...
        std::vector<uint32_t> ks(meta_data_->GetKeyMapping());
        ...
        BPlusTreeIndex<INDEX_KEY_TYPE, RowId, INDEX_COMPARATOR_TYPE>* index = new(mem)BPlusTreeIndex<INDEX_KEY_TYPE, RowId, INDEX_COMPARATOR_TYPE>(id, key_schema_, buffer_pool_manager);
        // cout<<"3"<<endl;
        index_ = index;
    }

    inline BPlusTreeIndex<GenericKey<32>, RowId, GenericComparator<32>>* GetIndex() { return index_; }
...
private:
    ...
    //Index* index_;
    BPlusTreeIndex<GenericKey<32>, RowId, GenericComparator<32>>* index_;
